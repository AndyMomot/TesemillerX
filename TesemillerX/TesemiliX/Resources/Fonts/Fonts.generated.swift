...
internal enum Fonts {
  ...
  internal enum LabSansPro {
    internal static let thin = FontConvertible(name: "LabSansPro-Thin", family: "Lab Sans Pro", path: "Lab Sans Pro-Thin.otf")
    internal static let all: [FontConvertible] = [thin]
  }
  internal static let allCustomFonts: [FontConvertible] = [KulimPark.all, LabSansPro.all].flatMap { $0 }
